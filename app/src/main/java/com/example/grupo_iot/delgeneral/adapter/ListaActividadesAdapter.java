package com.example.grupo_iot.delgeneral.adapter;
...
import com.example.grupo_iot.delgeneral.entity.Actividad;
...
public class ListaActividadesAdapter extends RecyclerView.Adapter<ListaActividadesAdapter.ActividadViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ActividadViewHolder holder, int position){
        ...
        TextView delegadoActividad = holder.itemView.findViewById(R.id.textView);


        nombreActividad.setText(actividad.getNombreActividad());
        descripcionActividad.setText(actividad.getDescripcionActividad());
        delegadoActividad.setText(actividad.getDelegadoActividad());
    ...
    public class  ActividadViewHolder extends RecyclerView.ViewHolder{
        ...
        public ActividadViewHolder(@NonNull View itemView){
            ...
            TextView delegadoActividad = itemView.findViewById(R.id.textView);
